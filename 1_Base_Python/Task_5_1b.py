...
def main():
    ...
    device_parameter = input(f"Введите треубуемый параметр устройства {', '.join(london_co.get(device_name).keys())}: ")
    print(london_co.get(device_name).get(device_parameter))
